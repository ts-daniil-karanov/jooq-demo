...
public class Test extends TableImpl<TestRecord> {
    ...
    /**
     * The reference instance of <code>jooq_demo.test</code>
     */
    ...
    /**
     * The column <code>jooq_demo.test.id</code>.
     */
    public final TableField<TestRecord, ULong> ID = createField(DSL.name("id"), SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");
    ...
    /**
     * Create an aliased <code>jooq_demo.test</code> table reference
     */
    ...
    /**
     * Create a <code>jooq_demo.test</code> table reference
     */
    public Test() {
    ...
    @Override
    public Identity<TestRecord, ULong> getIdentity() {
        return (Identity<TestRecord, ULong>) super.getIdentity();
    }
